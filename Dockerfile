...
COPY ./docker/thirdparty/patches/amf-1.4.36-display-capture-c.patch \
     ...
     ./docker/thirdparty/patches/ffmpeg-8.1.2-aresample-reinit-first-pts.patch \
     ./docker/thirdparty/patches/ffmpeg-8.1.2-vaapi-mesa-hevc-alignment.patch \
...
# --------------------------------------------------------------------------------------------------------------
# KonomiTV-BS4K TS Codec Bridge を submodule から構築するステージ
# --------------------------------------------------------------------------------------------------------------
...
# submodule の参照 commit が未確定なら、toolchain の取得より前に失敗する。
