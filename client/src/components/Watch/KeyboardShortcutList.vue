    ...
    left_column: [
        {
            ...
            icon_height: '22px',
            shortcuts: [
                { name: '数字キー/テンキーに対応するリモコン番号 (1~12) の地デジ・ワンセグチャンネルに切り替える', keys: [{name: '1~9, 0, -(=), ^(~)', icon: false}] },
    ...
    right_column: [
        ...
        },
        {
            ...
            shortcuts: [
                ...
                { name: 'ツイート送信先を切り替える<br>（紐付け済アカウント選択時のみ）', keys: [{name: 'Twitter タブを表示', icon: false}, {name: 'Shift', icon: false}, {name: 'Tab', icon: false}] },
